...
export default function LikesPage() {
  ...
  useEffect(() => {
    ...
    const liked = localStorage.getItem('nabiz_liked_articles');
    if (liked) {
      setArticles(JSON.parse(liked));
    } else {
      // Demo data
      setArticles([
        {
  ...
  const removeLike = (id: string) => {
    ...
    setArticles(updated);
    localStorage.setItem('nabiz_liked_articles', JSON.stringify(updated));
  };
            ...
            {articles.map((article) => (
              ...
              >
                ...
                <button
                  ...
                  className="self-start p-2 text-red-500 hover:text-red-600 transition-colors"
                >
