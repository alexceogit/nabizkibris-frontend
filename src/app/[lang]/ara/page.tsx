...
import { Search, Filter, X, Calendar, Eye, Clock, ChevronDown } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-4">
          <form onSubmit={handleSearch} className="flex gap-2">
            ...
            <button
              ...
              className={`btn-outline px-4 ${showFilters ? 'bg-primary text-white' : ''}`}
            >
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap gap-6">
              ...
              <div className="flex items-end">
                <button
                  onClick={() => setFilters({ category: 'Tümü', dateRange: 'all', sortBy: 'relevance' })}
        ...
        <div className="flex items-center justify-between mb-6">
          <p className="text-text-secondary dark:text-gray-400">
            {query ? (
              ...
              <span>Arama yapmak için yukarıya bir şeyler yazın</span>
            )}
          </p>
        </div>
        ...
        {loading ? (
              ...
              >
                <Link href={`/tr/${result.slug}`} className="flex gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <h2 className="text-xl font-bold text-text-primary dark:text-white hover:text-primary transition-colors line-clamp-1">
                      {result.title}
                    </h2>
                    <p className="mt-2 text-text-secondary dark:text-gray-400 line-clamp-2">
                      {result.excerpt}
                    </p>
                  </div>
                </Link>
          ...
          <div className="text-center py-16">
            ...
            <p className="text-text-secondary dark:text-gray-400 mb-6">
              "<strong>{query}</strong>" için sonuç bulunamadı. Farklı anahtar kelimeler deneyin.
            </p>
