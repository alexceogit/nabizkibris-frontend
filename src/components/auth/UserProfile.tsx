...
export default function UserProfile() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)]">
      {/* Cover Image */}
      <div className="h-48 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500"></div>

      {/* Profile Info */}
      <div className="px-4 sm:px-6 lg:px-8 -mt-20 relative">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white dark:bg-[#1E293B] rounded-2xl shadow-xl p-6 sm:p-8">
            {/* Header */}
            <div className="flex flex-col sm:flex-row items-start gap-6">
              ...
              <div className="relative">
                <img
                  ...
                  alt={user?.name}
                  className="w-32 h-32 rounded-full border-4 border-white dark:border-[#1E293B] shadow-lg"
                />
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-8 mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-500 dark:text-gray-400">Gönderi</div>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900 dark:text-white">{stats.likes.toLocaleString()}</div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">Beğeni</div>
                  </div>
                </div>
              </div>
            </div>
